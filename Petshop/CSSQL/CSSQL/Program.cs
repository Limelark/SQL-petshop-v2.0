            ...
            while (closeApp == false)
            {
                ...
                //Registre og login
                {
                        ...
                        case "2":
                            ...
                            while (true)
                            {
                                ...
                                using (IDbConnection cnn = new SQLiteConnection(SqliteDataAccess.LoadConnectionString()))
                                {
                                    try
                                    {
                                        List<CustomerModel> outputa = cnn.Query<CustomerModel>("SELECT * FROM Customers WHERE Name = '" + customerName + "'", new DynamicParameters()).ToList();
                                        string passwordChecka = outputa[0].Password;
                                    }
                                    catch 
                                    {
                    ...
                    while(closeApp2 == false)
                    {
                        ...
                        Console.WriteLine("Type 2 to view and buy Products");
                        Console.WriteLine("Type 3 to view your previous purchases");
                        Console.WriteLine("Type 4 to view and sort Products");
                        ...
                        switch (Option2)
                        {
                            ...
                            case "2":
                                ...
                                while (true)
                                {
                                    Console.WriteLine("\nType the ID on the Produkt you would like to buy, type sort to sort or type 0 to exit to menu");
                                ...
                                switch (Option4)
                                {
                                    case "y":
                                        ...
                                        Console.Clear();
                                        Console.WriteLine("Thank you for purchasing a product at the best petshop in the world\n");
                            ...
                            case "4":
                                string symbol = "i";
                                string number = "i";
                                Console.WriteLine("Type < to sort for products with a price lesser than you input, and type > to sort for products smaller than your input");
                                ...
                                while (true)
                                {
                                    Console.WriteLine("Write the price you would like to sort by");
                                    number = Console.ReadLine();
                                    try
                                    {
                                        int numberInt1 = int.Parse(number);
                                ...
                                productList = SqliteDataAccess.SortProduct(symbol, numberInt);
